            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Member /</span> Donation Report
                        </h4>
                            ...
                            <div class="col-md-8">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        <form action="{{ route('report.between') }}" enctype="multipart/form-data"
                                            method="post">
                                            @csrf
                                            <label class="form-label" for="startDate">Starting Date Of Report</label>
                                            ...
                                            <p class="mb-2">
                                                <span class="form-label" for="endingDate">Ending Date of Report</span>
                                            </p>
                                            <input type="date" name="endingDate" class="form-control pb-2 mb-2">
                                            <button type="submit" class="btn btn-primary me-2 m-1">Report</button>
                                        </form>
                                        <a href="{{ route('donation.report.generate') }}"
                                    class="btn btn-primary me-2 m-1">All Report</a>
                                    </div>
                                </div>
                            </div>
