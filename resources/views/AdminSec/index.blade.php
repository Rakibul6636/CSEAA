                            ...
                            <div class="col-lg-10 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Create your Post</h5>
                                                <form action="{{ route('admin.web.post') }}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    <!-- @method('PATCH') -->
                                                    <label>Title of your articles:</label>
                                                    <input id="title" name="title" placeholder="Your text here."
                                                        class="col-12 form-control mb-2">

                                                    <label>Details text of your articles:</label>
                                                    <textarea id="contentText" name="contentText"
                                                        placeholder="Your text here." class="col-12 form-control  mb-2">

                                                  </textarea>

                                                    <p class="mb-2">
                                                        <span class="fw-bold">your Image here</span>
                                                    </p>
                                                    <input type="file" name="image" class="form-control pb-2 mb-2">
                                                    <label>Type of your articles:</label>
                                                    <select class="form-select" name="type" aria-label="Default select example">
                                                        <option selected>Open this select menu</option>
                                                        <option value="0">President Message</option>
                                                        <option value="1">Upcoming Event</option>
                                                        <option value="2">Past Event</option>
                                                        <option value="3">Condolence Message</option>
                                                        <option value="4">Our Mission</option>
                                                        <option value="5">Constitutions</option>
                                                        <option value="6">Management</option>
                                                        <option value="7">Notice</option>
                                                        <option value="8">Journal</option>
                                                        <option value="9">Article</option>
                                                        <option value="10">Gallery</option>
                                                        <option value="11">Scholarship</option>
                                                        <option value="12">Sponsor</option>
                                                    </select>

                                                    <button type="submit" class="btn btn-primary me-2 m-1">Post</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12 col-lg-10 order-2 order-md-3 order-lg-2 mb-4">
                                <div class="card">
                                    <div class="row row-bordered g-0">
                                        <div class="col-md-8">
                                            <h5 class="card-header m-0 me-2 pb-3">{{$post->created_at->diffForHumans()}}
                                            </h5>
                                            <div class="px-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <span class="fw-bold"><a href="/profile/{{$post->user->id}}"
                                                            class="text-decoration-none"><span
                                                                class="text-dark ">{{$post->user->username}}</span></a></span>
                                                </div>
                                            </div>
                                            <div class=" ps-1 fw-semibold pt-3 mb-2">{{$post->caption}}</div>
