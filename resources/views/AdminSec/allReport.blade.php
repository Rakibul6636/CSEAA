            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Fund /</span>Overall Report
                        </h4>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <td>{{ $sl }}</td>
                                            ...
                                            <td><span class="badge bg-label-primary me-1">{{ $payment->amount }}</span>
                                             ...
                                             @php
                                        $sl = $sl +1;
                                        $tamountEarned = $tamountEarned + $payment->amount;
                                        @endphp
                                        @empty
                                        <tr>
                        ...
                        <div class="card mt-5">
                            <h5 class="card-header">Expense Summary</h5>
                            <div class="table-responsive text-nowrap">
                                @if (session('message'))
                                <div class="alert alert-success" role="alert">
                                    {{ session('message') }}
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <td>{{ $sl }}</td>
                                            ...
                                            <td><span class="badge bg-label-primary me-1">{{ $payment->amount }}</span>
                                             ...
                                             @php
                                        $sl = $sl +1;
                                        $tamountExpnesed = $tamountExpnesed + $payment->amount;
                                        @endphp
                                        @empty
                                        <tr>
                                            <td colspan="2">No payments found.</td>
                                        ...
                                        @endforelse
                                        <tr>
                                            <td colspan="2">Total Expensed Amount.</td>
                                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                <strong>{{ $tamountExpnesed }} </strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="card mt-5">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <td>1</td>
                                            ...
                                            <td colspan="2"><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                <strong>Balance </strong>
                                            </td>
                                            <td>
                                            @php
                                        $balance = $tamountEarned - $tamountExpnesed;
                                        @endphp
                                                {{ $balance }}
                                            </td>
                            ...
                            <a href="{{ ('http://127.0.0.1:8000/pdfAll') }}"
                                    class="btn btn-primary me-2 m-1">Download Report</a>
                        </div>
                        <!--/ Basic Bootstrap Table -->
