                            ...
                            <div class="col-lg-10 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Search Article</h5>
                                                <form action="{{ route('admin.web.manage') }}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    @method('post')
                                                    ...
                                                    <button type="submit" class="btn btn-primary me-2 m-1">Search</button>
                                                </form>
                                            </div>
                                        </div>
