            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Members /</span> Registration Request
                        </h4>

                        <!-- Basic Bootstrap Table -->
                        <div class="card">
                            <h5 class="card-header">Member Waiting</h5>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-primary me-1">{{ $user->created_at }}</span>
                                            </td>
                                            <td>
