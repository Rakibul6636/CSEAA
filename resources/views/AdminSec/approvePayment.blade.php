            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Approve Payment
                        </h4>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-primary me-1">{{ $payment->created_at }}</span>
                                            </td>
                                            <td>
                                                <a href="/storage/{{$payment->image}}" download="/storage/{{$payment->image}}">
                                            ...
                                            <td><a href="{{ route('admin.payment.approve', $payment->id) }}"
                                                    class="btn btn-success btn-sm">Approve</a></td>
                                            <td><a href="{{ route('admin.payment.reject', $payment->id) }}"
