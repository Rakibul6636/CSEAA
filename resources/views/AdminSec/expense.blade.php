            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Expense</h4>

                        <div class="row">
                            <!-- Basic -->
                            <div class="col-md-8">
                                <div class="card mb-4">
                                    <h5 class="card-header">Make Expense</h5>
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        <form action="{{ route('expense.make') }}" enctype="multipart/form-data"
                                            method="post">
                                            @csrf
                                            <label class="form-label"
                                                    for="purpose">Purpose of Expense</label>
