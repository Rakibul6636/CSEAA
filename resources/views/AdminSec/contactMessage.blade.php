            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Message /</span> Unread
                        </h4>

                        <!-- Basic Bootstrap Table -->
                        <div class="card">
                            <h5 class="card-header">Unread Message</h5>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-label-primary me-1">{{ $message->created_at }}</span>
                                            </td>
                                            <td>
                                                {{ $message->text }}
                                            </td>
                                            <td>
                                                ...
                                                <form action="mailto:{{$message->senderEmail}}" method="post"
                                                    enctype="text/plain">
                                                    <input class="btn btn-primary btn-sm" type="submit" value="Reply">
                                                </form>
                                            </td>
                                            <td><a href="{{ route('message.read', $message->id) }}"
                                                    class="btn btn-success btn-sm">Mark Read</a></td>
