                                    ...
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                ...
                                                <form action="/articleUpdate/{{$article->id}}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    @method('PATCH')
                                                    <label>Title of your articles:</label>
                                                    <input id="title" name="title" placeholder="Your text here."
                                                        class="col-12 form-control mb-2" value="{{ old('title') ?? $article->title }}">
                                                    ...
                                                    <textarea id="contentText" name="contentText"
                                                        ...
                                                        {{ old('contentText') ?? $article->contentText }}
                                                  </textarea>
